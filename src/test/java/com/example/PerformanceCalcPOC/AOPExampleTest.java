...
@Component
class MyAspect {
    @Before("execution(* com.example.PerformanceCalcPOC.HiByeService.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.example.PerformanceCalcPOC.HiByeService.*(..))", returning = "result")
